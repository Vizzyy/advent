...
print(f'highest_y: {highest_y}, floor: {highest_y + 2}')
floor_points = get_line_points([0, highest_y + 2], [grid_size - 1, highest_y + 2])
...
while not global_break and round_num <= round_limit:
    ...
    if final_position:
        ...
        units_at_rest += 1
        if final_position == sand_start:
            print(f'We have blocked the sand source!')
            break
    else:
        break
